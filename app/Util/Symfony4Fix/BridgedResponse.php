...
namespace App\Util\Symfony4Fix;

use OAuth2\ResponseInterface;

/**
 * Copied from OAuth2\HttpFoundationBridge\Response.php. Necessary due to
 * https://github.com/bshaffer/oauth2-server-httpfoundation-bridge/issues/31
 */
class BridgedResponse extends JsonResponse implements ResponseInterface
{
